        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <ScrollView style={{ height: global.h - 135 * global.hs, backgroundColor: "#EEEEEE" }}>
                    <View style={styles.snsView}>
                        ...
                        <View style={{ width: 40 }}>
                            <TouchableOpacity onPress={() => { Credential(this.props) }} >
                                <Image source={require('../../img/add.jpg')} style={{ width: 32 * global.hs, height: 32 * global.hs, marginRight: 10 * global.ws }} />
                            </TouchableOpacity>
                        </View>
                    </View>
                                            ...
                                            <View style={styles.media}>
                                                ...
                                                <ImageBackground source={{ uri: unescape(decodeURIComponent(val.thumb_url)) }}
                                                    ...
                                                    <TouchableOpacity onPress={() => { mediaDel(this.props, val.id) }}>
                                                        <Image source={require('../../img/images.jpg')} style={{ width: 20 * global.hs, height: 20 * global.hs, borderRadius: 15 * global.hs}}
                                                        >
                                                        </Image>
                    ...
                    <Text style={{ fontSize: 12 * global.hs, marginLeft: 20 * global.ws , marginBottom: 20 * global.ws}}>{global.DefaultTagMenu[global.Lang]}</Text>
                    ...
                    <Text style={{ fontSize: 12 * global.hs, marginLeft: 20 * global.ws , marginBottom: 20 * global.ws}}>{global.Hashtag[global.Lang]}</Text>
                    <View style={styles.customContainer}>
                        <TagInput
                            ...
                            labelStyle={{ color: '#000', fontSize: 14 * global.hs }}
                            leftElementContainerStyle={{ marginLeft: 3 * global.ws }}
                            containerStyle={{ width: global.w - 40 * global.ws }}
                            inputContainerStyle={[styles.textInput]}
                            inputStyle={{ color: this.state.tagsText, fontSize: 14 * global.hs }}
                    ...
                    <View style={{ marginLeft: 15 * global.ws, marginTop: 10 * global.hs , marginTop: 20 * global.ws}}>
                        <Text style={{ fontSize: 12 * global.hs , marginBottom: 20 * global.ws}}>定型テキスト</Text>
                        <View style={{
                ...
                <View style={styles.btnView}>
                    <Button
                        ...
                        color="red"
                        titleStyle={{ fontSize: 15 * global.hs }}
...
const styles = StyleSheet.create({
    txtArea: { width: screenWidth - 40 * global.ws, height: 120 * global.hs, paddingHorizontal:15 * global.ws , paddingTop: 15 * global.ws , marginLeft: 5 * global.ws,marginTop: 20 * global.hs, marginBottom: 10 * global.hs, backgroundColor: "#EEE" },

    btnView: { height: 65 * global.hs, alignItems: "center", backgroundColor: "#000", width: screenWidth, justifyContent: "center" ,marginBottom:1},
    ...
    media: { width: (screenWidth - 40 * global.ws) / 2, height: (screenWidth - 40 * global.ws) *9/16, marginHorizontal:10, paddingVertical:20, backgroundColor: "#fff", borderWidth: 1, borderColor: "#fff" },
    ...
    defTagTxt: {
        ...
        , borderColor: "#CCC", width: 100 * global.ws, borderRadius: 30 * global.hs, marginTop: 5 * global.hs
    },
